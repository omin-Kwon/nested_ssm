...
I am Omin Kwon, a Master's student in Prof. Jae W. Lee's group at Seoul National University - you may know our group through Stuart Sul, who did his research internship with us before joining Stanford. My research is on system-efficient LLM memory and serving systems. Most recently, I developed a sparse attention technique for block diffusion LLMs (Oral, AdaptFM @ ICML '26) and, in collaboration with the Sky Computing Lab at UC Berkeley, designed a CPU-GPU offloading technique for serving them efficiently (under review at ASPLOS).
