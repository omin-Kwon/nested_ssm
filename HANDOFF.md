...
- **[밤 마감 시점 진행 중] limit=1000 타이브레이커** (base/P4/P4-long c4-bf16, `final_{base,p4,p4long}_L1k.log`): 판정 규칙 — P4-long이 기준−0.5 이내면 P4-long 최종, 그 이상 뒤지면 P4(1200스텝 스윗스팟). **완료 시**: 최종 표 메모리·HANDOFF 기록, PAPER_OUTLINE 수치 배선 후보.
