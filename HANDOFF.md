...
- E-T2: 도메인별 M_task(wikitext vs 수학) top-32 부분공간 주각 → 태스크 공유/합집합 검증 (단, E-T1 결과상 명시-M 기반이라 해석 주의 — 학습 R의 도메인별 성능 전이가 더 직접적). E-T3: spectral warm-start — E-T1 결과상 유망하지 않음(명시 M이 답과 무상관), 우선순위 강등.
