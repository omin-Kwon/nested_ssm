...
- **★★★ 다운스트림 gap 봉합 (warmup window)**: 잔존 −1pt = 짧은-시퀀스 아티팩트 → **첫 W토큰 fresh 후 v4 전환**(--warm 64; 배포 의미론 = §8 one-time cold-ship). **실측 L1k: fresh 70.42 vs p4long+warm64 70.35 = 동률(−0.07).** 긴-시퀀스 증거 독립 성립(ppl 0%/needle 1.00/lambada ≈). **완성 배포점: v4-c4 + bf16-cold + warm64 = 실측 1.92×, 다운스트림 = fresh.** 이게 논문 §5 헤드라인.
