...
val = tokenize_split("validation"); np.save("wt103_val.npy", val); print("val tokens:", len(val), flush=True)
train = tokenize_split("train"); np.save("wt103_train.npy", train); print("train tokens:", len(train), flush=True)
